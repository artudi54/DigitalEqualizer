...
{    
  ...
  /* Use controller PLL as byte lane clock source before stopping DSIPHY clock source */
...
{    
  ...
  /* Switch the lanbyteclock source in the RCC from controller PLL to D-PHY */
